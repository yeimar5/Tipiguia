...
// IMPORTS
// ===========================================
import { limpiarTexto, FormatearFecha } from "./modulo-utilidades.mjs";
import * as DireccionPiloto from "./modulo-direccion-piloto.mjs";
import * as Agendar from "./modulo-agendar.mjs";
import * as Incumplimiento from "./modulo-incumplimiento.mjs";
import * as Quiebre from "./modulo-quiebre.mjs";
import * as noSoporte from "./modulo-soporteNA.mjs";
import * as Decos from "./modulo-gestionDecos.mjs";
...
const CAMPOS_FORMULARIO = [
  ...
  "noSoporte", "NomAgent", "Agent", "direccionSistema", "via",
  "tipoJornada", "DRP"
];
...
function obtenerValoresFormulario() {
  ...
  return {
    ...
    direcionenRecibo: campos.via?.value || "",
    direccionCompleta: `${campos.direccionSistema?.value || ""} ${campos.via?.value || ""}`.trim(),
  };
}
